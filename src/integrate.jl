...
function rk4(ntemp, ptemp, ztemp, btemp, dtemp, vtemp, otemp, prms, t, bloom, season)

    dNdt1, dPdt1, dZdt1, dBdt1, dDdt1, dVdt1, dOdt1 = model_functions(ntemp, ptemp, ztemp, btemp, dtemp, vtemp, otemp, prms, t, bloom, season)
    ...
    dNdt2, dPdt2, dZdt2, dBdt2, dDdt2, dVdt2, dOdt2 = model_functions(track_n1, track_p1, track_z1, track_b1, track_d1, track_v1, track_o1, prms, t, bloom, season)
    ...
    dNdt3, dPdt3, dZdt3, dBdt3, dDdt3, dVdt3, dOdt3  = model_functions(track_n2, track_p2, track_z2, track_b2, track_d2, track_v2, track_o2, prms, t, bloom, season)
    ...
    dNdt4, dPdt4, dZdt4, dBdt4, dDdt4, dVdt4, dOdt4 = model_functions(track_n3, track_p3, track_z3, track_b3, track_d3, track_v3, track_o3, prms, t, bloom, season)
